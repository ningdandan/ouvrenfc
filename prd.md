...
1. Project Overview
A high-frequency, dynamic landing page system for 100 physical wet market NFC tags. Each wet market maps to a unique URL path (/link/00001 to /link/00100). The system allows for "Physical-to-Digital" ownership activation via a 3-digit PIN and dynamic social link management.
